...
import excel "(wiiw) National accounts - GVA by activities", sheet("Worksheet") cellrange(A7:BS2797) firstrow case(preserve)
...
save gva_rev1, replace
clear

// merging the two adjusted revisions into one dataset //
use gva_rev2.dta 
merge 1:1 CountryCode sector year using gva_rev1.dta, nogenerate
