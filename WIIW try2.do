...
// Temporary save if anything goes wrong from with assigning new letters //
...
egen fdi_inflow36 = rowtotal(fdi_inflow39 fdi_inflow40), missing
label variable fdi_inflow24 "sum industries R and S"

drop fdi_inflow8 fdi_inflow11 fdi_inflow15 fdi_inflow19 fdi_inflow23 fdi_inflow26 fdi_inflow28 fdi_inflow39 fdi_inflow40
...
replace Industry = "R-S  Other community, social and personal services" if Industry == "Private purchases & sales of real estate"
replace Industry = "Z  Other not elsewhere classified activities" if Industry == "Other not elsewhere classified activities (A-U)"
...
drop if industry == 34 | industry == 36 | industry == 3 | industry == 27 | industry == 24

// making NACE letters consitent for Rev.1 //
reshape wide fdi_inflow, i(country year) j(industry)

egen fdi_inflow3 = rowtotal(fdi_inflow2 fdi_inflow4), missing
label variable fdi_inflow7 "sum industries A and B"

drop fdi_inflow2 fdi_inflow4
...
replace Industry = "O  Public administration, defence, compuls.soc.security" if Industry == "L  Public administration, defence, compuls.soc.security"
replace Industry = "P  Education" if Industry == "M  Education"
replace Industry = "Q  Human health and social work activities" if Industry == "N  Health and social work"
replace Industry = "R-S  Other community, social and personal services" if Industry == "O  Other community, social and personal services"
replace Industry = "Z  Other not elsewhere classified activities" if Industry == "Other not elsewhere classified activities (A-Q)"
replace Industry = "U  Activities of extra-territorial organisations & bodies" if Industry == "Q  Extra-territorial organizations & bodies"
